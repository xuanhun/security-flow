...
- Platform: `BTLO`
- Difficulty: `Medium`
- Source PDF: `https://github.com/tim-barc/ctf_writeups/blob/main/writeups/btlo_network_analysis_ransomware.pdf`
...
### Step 1: What is the operating system of the host from which the network traffic was captured?
...
- Result: `32-bit Windows 7 Service Pack 1, build 7601`

### Step 2: What is the full URL from which the ransomware executable was downloaded?
...
- Result: `http://10.0.2.15:8000/safecrypt.exe`

### Step 3: Name the ransomware executable file?
...
- Reasoning chain:
  ...
  - Trust the result only when the extracted evidence line or field directly supports it.
- Evidence rule: Trust the result only when the extracted evidence line or field directly supports it.
- Result: `safecrypt.exe`

### Step 4: What is the MD5 hash of the ransomware?
...
- Reasoning chain:
  ...
  - Trust the result only when the extracted evidence line or field directly supports it.
- Evidence rule: Trust the result only when the extracted evidence line or field directly supports it.
- Result: `4a1d88603b1007825a9c6b36d1e5de44`

### Step 5: What is the name of the ransomware?
...
### Step 6: What is the encryption algorithm used by the ransomware, according to the ransom note?
...
### Step 7: What is the domain beginning with ‘d’ that is related to ransomware traffic?
...
- Reasoning chain:
  ...
  - Trust the result only when the extracted evidence line or field directly supports it.
- Evidence rule: Trust the result only when the extracted evidence line or field directly supports it.
- Result: `dunyamuzelerimuzesi.com`
